...
/**
 * Random return activity/event generator, largely for debugging purposes
 * 
 * @author kenna
 */
public class Return_Generator {
     ...
     * Empty constructor
     */
    public Return_Generator(){}
    
    
    /**
     * Generate a random data for returning
     * 
    ...
    public String[] genRand(){
        ...
        output[3] = end_date[ rand.nextInt(end_date.length) ];
        output[4] = ReturnType.getState().toString();
